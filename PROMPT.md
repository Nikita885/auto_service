...
> Прочитай `README.md` и `PROMPT.md` — там полный контекст, архитектурные
> решения и правила. Бизнес-логика живёт только в `apps/*/services/`, вьюхи
> тонкие, ошибки — доменные исключения из `apps/common/exceptions.py`.
> Держись этих правил. Моя задача: …
